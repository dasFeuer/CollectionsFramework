...
public class IntermediateOps {
    public static void main(String[] args) {
        ...
        // 1. filter
        List<String> list = Arrays.asList("Nepal", "Germany", "Spain", "Norway", "Nepal");
        Stream<String> filteredStream = list.stream().filter(x -> x.startsWith("N"));
        // no filtering at this point
        long res = list.stream().filter(x -> x.startsWith("N")).count();
