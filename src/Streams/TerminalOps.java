...
public class TerminalOps {
    public static void main(String[] args) {
        ...
        List<String> phonesName = Arrays.asList("Samsung", "Pixel", "Nokia", "Iphone");
        System.out.println(phonesName.stream().filter(x -> x.length() > 3).toList());
        ...
        Stream<String> stream = phonesName.stream();
